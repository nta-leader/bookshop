            ...
            <div class="row">
                <div class="tg-featureditm">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 hidden-sm hidden-xs">
                        <figure><img src="{{ $urlTemplateBook }}/images/img-02.png" alt="image description"></figure>
                    </div>
                            ...
                            <div class="tg-newreleasebooks">
                                <div class="col-xs-4 col-sm-4 col-md-6 col-lg-4">
                                    <div class="tg-postbook">
                                        <figure class="tg-featureimg">
                                            <div class="tg-bookimg">
                                                <div class="tg-frontcover"><img src="{{ $urlTemplateBook }}/images/books/img-07.jpg" alt="image description"></div>
                                                <div class="tg-backcover"><img src="{{ $urlTemplateBook }}/images/books/img-07.jpg" alt="image description"></div>
                                            </div>
                                            <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                <i class="icon-heart"></i>
                                                <span>add to wishlist</span>
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-6 col-lg-4">
                                    <div class="tg-postbook">
                                        <figure class="tg-featureimg">
                                            <div class="tg-bookimg">
                                                <div class="tg-frontcover"><img src="{{ $urlTemplateBook }}/images/books/img-08.jpg" alt="image description"></div>
                                                <div class="tg-backcover"><img src="{{ $urlTemplateBook }}/images/books/img-08.jpg" alt="image description"></div>
                                            </div>
                                            <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                <i class="icon-heart"></i>
                                                <span>add to wishlist</span>
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-4 hidden-md">
                                    <div class="tg-postbook">
                                        <figure class="tg-featureimg">
                                            <div class="tg-bookimg">
                                                <div class="tg-frontcover"><img src="{{ $urlTemplateBook }}/images/books/img-09.jpg" alt="image description"></div>
                                                <div class="tg-backcover"><img src="{{ $urlTemplateBook }}/images/books/img-09.jpg" alt="image description"></div>
                                            </div>
                                            <a class="tg-btnaddtowishlist" href="javascript:void(0);">
                                                <i class="icon-heart"></i>
                                                <span>add to wishlist</span>
                ...
                <div id="tg-pickedbyauthorslider" class="tg-pickedbyauthor tg-pickedbyauthorslider owl-carousel">
                    <div class="item">
                        <div class="tg-postbook">
                            <figure class="tg-featureimg">
                                <div class="tg-bookimg">
                                    <div class="tg-frontcover"><img src="{{ $urlTemplateBook }}/images/books/img-10.jpg" alt="image description"></div>
                                </div>
                    ...
                    <div class="item">
                        <div class="tg-postbook">
                            <figure class="tg-featureimg">
                                <div class="tg-bookimg">
                                    <div class="tg-frontcover"><img src="{{ $urlTemplateBook }}/images/books/img-11.jpg" alt="image description"></div>
                                </div>
                                <div class="tg-hovercontent">
                                    <div class="tg-description">
                                        <p>Consectetur adipisicing elit sed do eiusmod tempor incididunt labore toloregna aliqua enim adia minim veniam, quis nostrud.</p>
                    ...
                    <div class="item">
                        <div class="tg-postbook">
                            <figure class="tg-featureimg">
                                <div class="tg-bookimg">
                                    <div class="tg-frontcover"><img src="{{ $urlTemplateBook }}/images/books/img-12.jpg" alt="image description"></div>
                                </div>
                                <div class="tg-hovercontent">
                                    <div class="tg-description">
                                        <p>Consectetur adipisicing elit sed do eiusmod tempor incididunt labore toloregna aliqua enim adia minim veniam, quis nostrud.</p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-lg-push-2">
                        <div id="tg-testimonialsslider" class="tg-testimonialsslider tg-testimonials owl-carousel">
                            <div class="item tg-testimonial">
                                <figure><img src="{{ $urlTemplateBook }}/images/author/imag-02.jpg" alt="image description"></figure>
            ...
            <div class="row">
                ...
                <div id="tg-authorsslider" class="tg-authors tg-authorsslider owl-carousel">
                    <div class="item tg-author">
                        <figure><a href="javascript:void(0);"><img src="{{ $urlTemplateBook }}/images/author/imag-03.jpg" alt="image description"></a></figure>
                    ...
                    <div class="item tg-author">
                        <figure><a href="javascript:void(0);"><img src="{{ $urlTemplateBook }}/images/author/imag-04.jpg" alt="image description"></a></figure>
                        <div class="tg-authorcontent">
                    ...
                    <div class="item tg-author">
                        <figure><a href="javascript:void(0);"><img src="{{ $urlTemplateBook }}/images/author/imag-05.jpg" alt="image description"></a></figure>
                        <div class="tg-authorcontent">
                    ...
                    <div class="item tg-author">
                        <figure><a href="javascript:void(0);"><img src="{{ $urlTemplateBook }}/images/author/imag-06.jpg" alt="image description"></a></figure>
                        <div class="tg-authorcontent">
                    ...
                    <div class="item tg-author">
                        <figure><a href="javascript:void(0);"><img src="{{ $urlTemplateBook }}/images/author/imag-07.jpg" alt="image description"></a></figure>
                        <div class="tg-authorcontent">
                    ...
                    <div class="item tg-author">
                        <figure><a href="javascript:void(0);"><img src="{{ $urlTemplateBook }}/images/author/imag-08.jpg" alt="image description"></a></figure>
                        <div class="tg-authorcontent">
