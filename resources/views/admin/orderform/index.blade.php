...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-pie-chart"></i> Các đơn hàng mới</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Các đơn hàng mới</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        @if(Session::has('msg'))
                        ...
                        <div class="box-group" id="accordion">
                            ...
                            @php
                                ...
                                $urlConfirm = route('admin.orderform.comfirm',['id_order_form'=>$id]);
                                $urlCancelOrder = route('admin.orderform.cancelorder',['id_order_form'=>$id]);
                            @endphp
                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="6" style="text-align:right;">
                                                            <a data-url="{{ $urlConfirm }}" data-content="Bạn có muốn xác nhập đơn hàng này không !" class="confirm btn btn-success">Xác hận đơn hàng</a>
                                                            <a data-url="{{ $urlCancelOrder }}" data-content="Bạn có muốn hủy đơn hàng này không !" class="confirm btn btn-danger">Hủy đơn hàng</a>
                                                        </td>
                                                        <td>{{ number_format($sum,0,'.',',') }} đ</td>
                                                    </tr>
                                                </tbody>
